            ...
            <v-dialog v-model="alertSucces">
                <v-card color="success" max-width="800" min-width="344" height="80">
                    <v-card-text>
                        ...
                        </v-avatar>Cliente cadastrado com sucesso!
                    </v-card-text>
...
export default {
    ...
    methods: {
        ...
        async validate() {
            ...
            if (valid == true && this.situacao != null && this.tipocliente != null && this.uf != null && this.cidade != null) this.salvar()
        ...
        async salvar() {
            ...
            await fetch(`${this.$baseUrlApiMain}/cliente/create/${companyId}`, {
                method: "POST",
