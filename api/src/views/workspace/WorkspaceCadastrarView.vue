            ...
            <v-dialog v-model="alertSucces">
                <v-card color="success" max-width="800" min-width="344" height="80">
                    <v-card-text>
                        ...
                        </v-avatar>Workspace cadastrado(a) com sucesso!
                    </v-card-text>
...
export default {
    ...
    methods: {    
        async validate() {
            ...
            if (valid == true && this.workspacename != null && this.workspaceid != null && this.tenantid != null && this.clientid != null && this.clientsecret != null && this.appid != null) this.salvar()
        ...
        async salvar() {
            ...
            await fetch(`${this.$baseUrlApiMain}/workspace/create`, {
                method: "POST",
