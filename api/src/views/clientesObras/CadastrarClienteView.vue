        ...
        <v-card elevation="10">
            ...
            <v-card-text>
                ...
                <v-form ref="form">
                    <v-row>
                        <v-col>
                            <v-text-field :rules="rules" variant="outlined" v-model="nomempresa" label="Nome Empresa *"
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <v-autocomplete :rules="rules" label="Cidade *" variant="solo" v-model="fat_cidade"
                                :items="fat_listacidades" :disabled="!fat_liberaCidades"></v-autocomplete>
...
export default {
    ...
    methods: {
        ...
        async validate() {
            ...
            if (valid == true && this.nomeobra != null && this.cnoobra != null && this.uf != null && this.cidade != null) this.salvar()
        ...
        async salvar() {
            ...
            if (this.cnoobra == null || this.cnoobra == "") {
                this.cnoobra = "Não Informado";
            }
            ...
            await fetch(`${this.$baseUrlApiMain}/clienteObra/create/${companyId}`, {
                method: "POST",
